        ...
        [#list squads?sort_by("code") as squad]
            ...
            [#assign totalGREEN = totalGREEN + (datas.get(squad.id).get(GREENID))?default(0)]
					<tr align="center">
						...
						<td>${squadTotal!}</td>
						<td>
                [@b.a href="grade-warning!search?gradeWarning.std.state.squad.id=" + squad.id + "&gradeWarning.semester.id=" + currentSemester.id + "&gradeWarning.warningType.id=" + REDID target="_blank"]
                ...
                [/#if]
						...
						<td>
                [@b.a href="grade-warning!search?gradeWarning.std.state.squad.id=" + squad.id + "&gradeWarning.semester.id=" + currentSemester.id + "&gradeWarning.warningType.id=" + YELLOWID target="_blank"]
                ...
                [/#if]
						...
						<td>
                [@b.a href="grade-warning!search?gradeWarning.std.state.squad.id=" + squad.id + "&gradeWarning.semester.id=" + currentSemester.id + "&gradeWarning.warningType.id=" + GREENID target="_blank"]
