...
[@b.tabs]
  ...
  [@b.form action=sa theme="list"]
    ...
    [@b.select name="statRule.method.id" value="${(statRule.method.id)!}"
    ...
    [@b.select name="statRule.warningType.id" value="${(statRule.warningType.id)!}"
               style="width:200px;" items=warningTypes option="id,name" empty="..."/]
    [@b.formfoot]
